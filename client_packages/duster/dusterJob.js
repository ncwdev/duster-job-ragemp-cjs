...
const utils = require('duster/utils.js');
const FeatureLevels = require('duster/FeatureLevels.js');
const EntityParticleEffect = require('duster/EntityParticleEffect.js');
...
function updateDusterJobGui() {
    ...
    if (levelInfo.isLast || levelInfo.lvl === 1) {
        ...
        const prevLevelInfo = config.levels[levelInfo.lvl - 2];
